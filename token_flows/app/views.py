...
API_TOKENS = ['V9MH4DCQ3BSHNAAQ6PDW5KNTGSXVIVZUQ3','5WUNMC9GI3HNWSC5NTSH5FQQCPVRVM4RN2','AKSEKH56BYQ5KNZ92PZJ3SR7YB1AZ1WPDS','K35XCVJA83WWYXVRV4Z2ZDCCJW2Y1YWDAJ','A9PVA23UFVUJY6DWTXUS1VVCBEZ5TG1G9D',
...
def apiFn(address = ADDRESS, afterBlock=0, beforeBlock=99999999,processed=None, depth=1):
    ...
    for element in data['result'][0:2]:
        ...
        processed = apiFn(element['to'], element['blockNumber'], beforeBlock, processed, depth+1)
        # print(processed)
    return processed

def apiFnERC20(address = ADDRESS, afterBlock=0, beforeBlock=99999999,processed=None, depth=1):
    ...
    for element in data['result'][0:3]:
        ...
        processed = apiFnERC20(element['to'], element['blockNumber'], beforeBlock, processed, depth+1)
    return processed
...
class TokenFlows(APIView):
    def get(self, request):
        ...
        # print(eth_transfers,all_transfers)
